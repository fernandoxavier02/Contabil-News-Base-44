...
export default function TelegramSettingsPage() {
  ...
  const handleSubmit = async (configData) => {
    try {
      ...
      alert("Ocorreu um erro ao salvar a configuração. Verifique o console.");
    }
  };
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div className="text-white">
                  <h1 className="text-3xl font-bold mb-2">Integração com Telegram</h1>
                  <p className="text-white/80">Configure canais e automação com IA</p>
                </div>
              </div>
              <Button 
                onClick={() => {
          ...
          <div className="bg-blue-100/80 backdrop-blur-lg border border-blue-300 rounded-xl p-6 mb-8">
            <h3 className="font-semibold text-blue-900 mb-3 flex items-center gap-2">
              ...
              Como configurar com tópicos:
            </h3>
            <ol className="text-sm text-blue-800 space-y-2 list-decimal list-inside">
              <li>Crie um bot no Telegram através do @BotFather</li>
              <li>Copie o token do bot fornecido</li>
              <li>Crie tópicos no seu grupo (Menu → Tópicos → Criar Tópico)</li>
              <li>Adicione o bot como administrador do grupo</li>
              <li>Para obter o ID do tópico: envie uma mensagem no tópico e encaminhe para @userinfobot</li>
              <li>Configure aqui: use o mesmo channel_id para o grupo, mas diferentes message_thread_id para cada tópico</li>
              <li>Cada categoria pode ir para um tópico diferente automaticamente!</li>
            </ol>
          </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Envio Automático</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-6">Comece criando sua primeira configuração de canal</p>
              <Button
                onClick={() => {
                  setEditingConfig(null);
                  setShowForm(true);
