...
export default function TelegramConfigCard({ config, onEdit, onDelete, onToggleActive }) {
  return (
    <motion.div
    ...
    >
      <Card className={`relative overflow-hidden transition-all duration-300 hover:shadow-lg ${
        config.is_active ? 'border-blue-200 bg-white' : 'border-gray-200 bg-gray-50 opacity-75'
      }`}>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600">Canal ID:</span>
