...
import { Mail, Edit, Trash2, Eye, EyeOff, CheckCircle, Clock } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export default function EmailConfigCard({ config, onEdit, onDelete, onToggleActive }) {
  return (
    <motion.div
    ...
    >
      <Card className={`relative overflow-hidden transition-all duration-300 hover:shadow-lg ${
        config.is_active ? 'border-orange-200 bg-white' : 'border-gray-200 bg-gray-50 opacity-75'
      }`}>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <CardTitle className="text-lg font-bold text-gray-900 mb-1">
                  {config.list_name || "Lista de Email"}
                </CardTitle>
