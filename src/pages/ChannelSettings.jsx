        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl p-8 mb-8 border border-white">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-4xl font-bold text-[#002855] mb-3">Configuracao de Canais</h1>
                <p className="text-lg text-[#58595B]">
                  Configure seus canais de distribuicao automatica de noticias
                </p>
              </div>
              ...
              <TabsContent value="telegram" className="mt-0">
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500 mb-4">
                    Para configurar o Telegram, acesse a pagina dedicada
                  </p>
                  <Link 
                    to="/TelegramSettings" 
